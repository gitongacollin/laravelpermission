...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('home')}}" class="logo">
      ...
      <span class="logo-lg"><b>Strathmore</b>AMS</span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="{{ asset('dist/img/user2-160x160.jpg') }}" class="img-square" alt="User Image">
                      </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="{{ route('users.index')}}"><i class="fa fa-link"></i> <span>Manage Users</span>
        ...
        <li class="treeview">
          <a href="{{ route('posts.index')}}"><i class="fa fa-link"></i> <span>Manage Post</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="{{ route('posts.index')}}"><i class="fa fa-link"></i> <span>Courses</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
